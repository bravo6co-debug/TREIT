...
function AppContent() {
  ...
  return (
    <div className="max-w-md mx-auto bg-white min-h-screen relative rounded-t-3xl shadow-2xl overflow-hidden">
      {/* Main Content */}
      <div className="pb-20">
        {renderScreen()}
      </div>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 p-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition-colors duration-200 shadow-lg"
        title="로그아웃"
      >
        <LogOut size={20} />
      </button>
