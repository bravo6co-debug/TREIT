...
export default function LoginScreen({ onLoginSuccess, onSwitchToSignup }: LoginScreenProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      console.log('LoginScreen: Attempting login for:', loginData.email);
      const success = await login(loginData.email, loginData.password);
      
      if (success) {
        console.log('LoginScreen: Login successful, calling onLoginSuccess');
        onLoginSuccess();
      } else {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      console.log('LoginScreen: Attempting signup for:', signupData.email);
